...
function Faqsss() {
  return (
    <div className="flex flex-col lg:gap-6 md:gap-5 gap-4 gap w-full">
        <Faqs question="How do I start using WorkFotos?" answer="Simply sign up, create your first project, and start uploading site photos from any device—no setup headaches."/>
