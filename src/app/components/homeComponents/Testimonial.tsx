...
const Testimonial: React.FC<testimonialProps> = ({
  ...
  return (
    <>
      <div className="lg:py-7 md:py-8 scroll-snap-center relative lg:pl-[36px] lg:pr-[52px] md:pr-[38px] pr-[16px] pl-[16px] py-5 md:pl-[38px] overflow-hidden bg-[url('/testimonialbg.svg')] text-black max-w-[800px]  lg:min-w-[800px] md:min-w-[700px] min-w-[300px] lg:w-[76%] w-[100%] rounded-2xl flex flex-col gap-12 items-start justify-center">
        ...
        <div className="flex flex-col lg:gap-4 gap-3">
          ...
          <h3 className="text-left md:text-center lg:text-xl md:text-[16px] text-sm w-fit">{saying}</h3>
        </div>
